...
class CoachMenuDrawer extends BaseComponent {
    ...
    getData("header", (value) => {
      ...
      this.props
        ...
        .then(() => {
          let data = this.props.data.profileData;
          console.log(
            "logout payload " + JSON.stringify(this.props.data.profileData)
          );
        })
        .catch((response) => {
          console.log(response);
  ...
  getCoachMenu() {
    ...
    if (user_type == COACH) user_type_str = "Coach";
    else if (user_type == ACADEMY) user_type_str = "Academy";
    ...
    return (
      <View>
          ...
          >
            ...
            <View>
              ...
              >
                ...
                <RateViewBorder>{ratings}</RateViewBorder>
              </View>
            </View>
          </View>
        </View>
        ...
        >
          <View style={styles.drawercell}>
            <Text style={styles.menu_coach}>View Society Feedback</Text>
        ...
        {user_type == COACH && (
          <TouchableOpacity
            activeOpacity={0.8}
            onPress={() => this.props.navigation.navigate("AcademyListing")}
          >
            <View style={styles.drawercell}>
              <Text style={styles.menu_coach}>Coaching Plans</Text>
        ...
        <TouchableOpacity
          activeOpacity={0.8}
          onPress={() => this.props.navigation.navigate("CoachRewardPoints")}
        >
          <View style={styles.drawercell}>
        ...
        <TouchableOpacity
          activeOpacity={0.8}
          onPress={() => this.props.navigation.navigate("LeaderboardRoute")}
        >
          <View style={styles.drawercell}>
        ...
        <TouchableOpacity
          activeOpacity={0.8}
          onPress={() =>
            this.props.navigation.navigate("ChallengeDisputeScreen")
          }
        >
          <View style={styles.drawercell}>
        ...
        {this.state.user_type == ACADEMY && (
          <TouchableOpacity
            activeOpacity={0.8}
            onPress={() => this.props.navigation.navigate("DuePaymentsScreen")}
          >
            <View style={styles.drawercell}>
        ...
        {this.state.user_type == ACADEMY && (
          <TouchableOpacity
            activeOpacity={0.8}
            onPress={() => this.props.navigation.navigate("PaymentReport")}
          >
            <View style={styles.drawercell}>
        ...
        <View style={[defaultStyle.line_style, { marginLeft: 12 }]} />
        ...
        >
          <View style={styles.drawercell}>
            <Text style={styles.menu_coach}>Sign Out</Text>
          </View>
        </TouchableOpacity>
  ...
  parentCell = (obj, show_edit) => {
    return (
      ...
      >
        <Text
          numberOfLines={1}
          style={[defaultStyle.bold_text_14, { width: 200, color: "#CECECE" }]}
        >
          {obj.name}
        </Text>
        <Text style={[defaultStyle.regular_text_12, { color: "#CECECE" }]}>
          {obj.phone_number}
        </Text>
      </View>
    );
  ...
  getPlayerMenu() {
    ...
    let ratings = 5;
    let academy_rating =
      this.state.academy_rating == undefined ? 0 : this.state.academy_rating;
    //user_type = COACH
    //signedIn = true
    ...
    for (let i = 0; i < size; i++) {
      ...
      related_players_array.push(this.parentCell(obj));
    }
    ...
    for (let i = 0; i < size; i++) {
      ...
      related_guardians_array.push(this.parentCell(obj));
    }
    ...
    return (
      <View>
        ...
        this.state.learnDataVisibility ? (
          <View
            style={{
              paddingLeft: 16,
              paddingRight: 16,
          ...
          >
            <Text style={defaultStyle.regular_text_10}>Guardian</Text>
        ...
        {this.state.learnDataVisibility && (
          ...
          >
            <View style={styles.drawercell}>
              <Text style={styles.menuTxt}>Batch details</Text>
              <Image
                style={styles.arrow_img}
                source={require("../images/ic_drawer_arrow.png")}
              />
        ...
        {this.state.learnDataVisibility && (
          ...
          >
            <View style={styles.drawercell}>
              <Text style={styles.menuTxt}>Purchase Plan</Text>
              <Image
                style={styles.arrow_img}
                source={require("../images/ic_drawer_arrow.png")}
              />
        ...
        {this.state.playDataVisibility ? (
          <View style={{ paddingLeft: 28 }}>
            ...
            >
              <View style={styles.drawercell}>
                <Text style={styles.menuTxt}>Book Slot</Text>
            ...
            >
              <View style={styles.drawercell}>
                <Text style={styles.menuTxt}>My Booking</Text>
                <Image
                  style={styles.arrow_img}
                  source={require("../images/ic_drawer_arrow.png")}
                />
