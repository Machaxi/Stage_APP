    ...
    return (
      <View style={styles.mainContainer}>
        ...
        <LinearGradient locations={[0.17, 0.97]} colors={['#A1DFFF', '#F4F4F4']} style={{padding: 40} } useAngle angle={194}>
          ...
          <View style={{ backgroundColor: '#F5F5F5', marginTop: 25, flexDirection: 'row', justifyContent: 'center', alignItems: 'center', borderRadius: 5 , shadowColor: 'black',  elevation: 4, shadowRadius: 15,
