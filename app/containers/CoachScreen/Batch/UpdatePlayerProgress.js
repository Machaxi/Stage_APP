...
import { getPlayerProgress, savePlayerProgress } from "../../../redux/reducers/PlayerProgressReducer";
...
class UpdatePlayerProgress extends BaseComponent {
    ...
    componentDidMount() {
        ...
        getData('userInfo', (value) => {
            ...
            if (userType == COACH || userType == ACADEMY) {
                ...
                this.getCoachPerformenceData(this.props.navigation.getParam('batch_id'), this.props.navigation.getParam('player_id'))
    ...
    getCoachPerformenceData(batch_id, player_id) {
        getData('header', (value) => {
            this.props.getPlayerProgress(value, batch_id, player_id).then(() => {
                let user = JSON.stringify(this.props.data.progressdata);
                console.log(' getPlayerProgress payload ' + user);
    ...
    savePlayerPerformanceToServer() {
        ...
        getData('header', (value) => {
            ...
            var data = {};
            data['month'] = this.state.batchDetails['month'];
            data['year'] = this.state.batchDetails['year'];
            ...
            this.state.playerList.map((item, index) => {
                ...
                this.props.savePlayerProgress(value, postData).then(() => {
            ...
            <View style={{
                ...
                <View style={{ flexDirection: 'row', width: '45%', justifyContent: 'space-between', marginRight: 20 }}>
                    <Text style={[defaultStyle.bold_text_12, {
                        ...
                        {moment(this.state.batchDetails['month'] + '-' + this.state.batchDetails['year'], "MM/YYYY").format('MMM')}
                    </Text>
                    <Text style={[defaultStyle.bold_text_12, { color: '#A3A5AE' }]}>
                    ...
                    <View style={{ backgroundColor: 'white', padding: 16 }}>
                        ...
                        <View style={{ marginTop: 20, marginBottom: 10 }}>
                            ...
                            <View style={{ flexDirection: 'row', justifyContent: 'space-between', }}>
                                <Text style={defaultStyle.bold_text_14}>{moment(this.state.batchDetails['month'] + '/' + this.state.batchDetails['year'], "MM/YYYY").format("MMM'YY")} </Text>
...
const mapStateToProps = state => {
    return {
        data: state.PlayerProgressReducer,
    };
};
const mapDispatchToProps = {
    getPlayerProgress, savePlayerProgress
};
export default connect(mapStateToProps, mapDispatchToProps)(UpdatePlayerProgress);
