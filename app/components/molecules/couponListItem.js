...
const CouponListItem = ({
  ...
  return (
    <LinearGradient
      ...
      colors={
        couponApplied ? ["#614a396e", "#5b4d431a"] : ["#ffffff3d", "#ffffff09"]
      }
      style={[
    ...
    >
      ...
      <View style={styles.couponDetails}>
        <View style={[commonStyles.flexRowSpaceBtw, { marginBottom: 8 }]}>
        ...
        <Text style={[styles.applyCoupon, { marginBottom: 5, marginLeft: 5 }]}>
          {"Use this code & get "}
