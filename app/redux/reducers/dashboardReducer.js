...
export function getPlayerDashboard(header, player_id, academy_id, sport_id) {
  if (academy_id == null) academy_id = "";
  // var header =
      ...
      request: {
        url:
          sport_id != "undefined" && sport_id != null
            ? `player/academic-profile?player_id=${player_id}&academy_id=${academy_id}&sport_id=${sport_id}`
            : `player/academic-profile?player_id=${player_id}&academy_id=${academy_id}`,
        method: "GET",
        // data: postdata,
        headers: {
